...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\gangyi-wuliu-scene\episodes\ep09"
```
...
- `output_name`: `刚毅物流-ep09-agent-cli-storyboard.txt`
