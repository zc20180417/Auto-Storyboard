...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep28"
```
...
```json
{
  "episode_id": "ep28",
  "status": "done",
  "output_name": "qimingzhizao-ep28-ep28-agent-cli-storyboard.txt",
