...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep02"
```
...
```json
{
  "episode_id": "ep02",
  "status": "done",
  "output_name": "qimingzhizao-ep02-ep02-agent-cli-storyboard.txt",
