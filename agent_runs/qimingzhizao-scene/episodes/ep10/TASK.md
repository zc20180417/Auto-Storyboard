...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep10"
```
...
```json
{
  "episode_id": "ep10",
  "status": "done",
  "output_name": "qimingzhizao-ep10-ep10-agent-cli-storyboard.txt",
