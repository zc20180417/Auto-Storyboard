...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep36"
```
...
```json
{
  "episode_id": "ep36",
  "status": "done",
  "output_name": "qimingzhizao-ep36-ep36-agent-cli-storyboard.txt",
