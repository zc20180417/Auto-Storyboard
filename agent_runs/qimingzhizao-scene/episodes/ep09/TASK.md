...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep09"
```
...
```json
{
  "episode_id": "ep09",
  "status": "done",
  "output_name": "qimingzhizao-ep09-ep09-agent-cli-storyboard.txt",
