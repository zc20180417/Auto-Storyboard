...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep32"
```
...
```json
{
  "episode_id": "ep32",
  "status": "done",
  "output_name": "qimingzhizao-ep32-ep32-agent-cli-storyboard.txt",
