...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep05"
```
...
```json
{
  "episode_id": "ep05",
  "status": "done",
  "output_name": "qimingzhizao-ep05-ep05-agent-cli-storyboard.txt",
