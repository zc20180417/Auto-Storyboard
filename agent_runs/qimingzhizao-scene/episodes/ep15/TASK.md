...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep15"
```
...
```json
{
  "episode_id": "ep15",
  "status": "done",
  "output_name": "qimingzhizao-ep15-ep15-agent-cli-storyboard.txt",
