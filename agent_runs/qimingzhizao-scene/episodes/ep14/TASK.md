...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep14"
```
...
```json
{
  "episode_id": "ep14",
  "status": "done",
  "output_name": "qimingzhizao-ep14-ep14-agent-cli-storyboard.txt",
