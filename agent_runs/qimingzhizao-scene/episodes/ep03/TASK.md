...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep03"
```
...
```json
{
  "episode_id": "ep03",
  "status": "done",
  "output_name": "qimingzhizao-ep03-ep03-agent-cli-storyboard.txt",
