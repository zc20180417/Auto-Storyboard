...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep08"
```
...
```json
{
  "episode_id": "ep08",
  "status": "done",
  "output_name": "qimingzhizao-ep08-ep08-agent-cli-storyboard.txt",
