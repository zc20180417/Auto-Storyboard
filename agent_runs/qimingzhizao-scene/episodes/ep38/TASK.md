...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep38"
```
...
```json
{
  "episode_id": "ep38",
  "status": "done",
  "output_name": "qimingzhizao-ep38-ep38-agent-cli-storyboard.txt",
