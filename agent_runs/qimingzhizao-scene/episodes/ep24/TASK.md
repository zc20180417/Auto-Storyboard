...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep24"
```
...
```json
{
  "episode_id": "ep24",
  "status": "done",
  "output_name": "qimingzhizao-ep24-ep24-agent-cli-storyboard.txt",
