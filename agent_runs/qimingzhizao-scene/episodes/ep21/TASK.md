...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep21"
```
...
```json
{
  "episode_id": "ep21",
  "status": "done",
  "output_name": "qimingzhizao-ep21-ep21-agent-cli-storyboard.txt",
