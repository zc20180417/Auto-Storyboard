...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep20"
```
...
```json
{
  "episode_id": "ep20",
  "status": "done",
  "output_name": "qimingzhizao-ep20-ep20-agent-cli-storyboard.txt",
