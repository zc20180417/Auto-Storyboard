...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep27"
```
...
```json
{
  "episode_id": "ep27",
  "status": "done",
  "output_name": "qimingzhizao-ep27-ep27-agent-cli-storyboard.txt",
