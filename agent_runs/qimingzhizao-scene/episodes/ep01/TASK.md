...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\qimingzhizao-scene\episodes\ep01"
```
...
```json
{
  "episode_id": "ep01",
  "status": "done",
  "output_name": "qimingzhizao-ep01-ep01-agent-cli-storyboard.txt",
