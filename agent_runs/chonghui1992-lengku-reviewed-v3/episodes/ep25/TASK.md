...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep25"
```
...
```json
{
  "episode_id": "ep25",
  "status": "done",
  "output_name": "EP-25-ep25-agent-cli-storyboard.txt",
