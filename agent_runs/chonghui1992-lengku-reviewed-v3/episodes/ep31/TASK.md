...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep31"
```
...
```json
{
  "episode_id": "ep31",
  "status": "done",
  "output_name": "EP-31-ep31-agent-cli-storyboard.txt",
