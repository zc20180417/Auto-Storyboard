...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep19"
```
...
```json
{
  "episode_id": "ep19",
  "status": "done",
  "output_name": "EP-19-ep19-agent-cli-storyboard.txt",
