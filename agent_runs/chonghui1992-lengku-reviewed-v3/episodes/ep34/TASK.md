...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep34"
```
...
```json
{
  "episode_id": "ep34",
  "status": "done",
  "output_name": "EP-34-ep34-agent-cli-storyboard.txt",
