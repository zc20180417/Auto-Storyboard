...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep17"
```
...
```json
{
  "episode_id": "ep17",
  "status": "done",
  "output_name": "EP-17-ep17-agent-cli-storyboard.txt",
