...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep08"
```
...
```json
{
  "episode_id": "ep08",
  "status": "done",
  "output_name": "EP-08-ep08-agent-cli-storyboard.txt",
