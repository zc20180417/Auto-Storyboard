...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep09"
```
...
```json
{
  "episode_id": "ep09",
  "status": "done",
  "output_name": "EP-09-ep09-agent-cli-storyboard.txt",
