...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep07"
```
...
```json
{
  "episode_id": "ep07",
  "status": "done",
  "output_name": "EP-07-ep07-agent-cli-storyboard.txt",
