...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep20"
```
...
```json
{
  "episode_id": "ep20",
  "status": "done",
  "output_name": "EP-20-ep20-agent-cli-storyboard.txt",
