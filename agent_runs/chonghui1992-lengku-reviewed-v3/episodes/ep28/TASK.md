...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep28"
```
...
```json
{
  "episode_id": "ep28",
  "status": "done",
  "output_name": "EP-28-ep28-agent-cli-storyboard.txt",
