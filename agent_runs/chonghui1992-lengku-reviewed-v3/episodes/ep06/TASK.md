...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep06"
```
...
```json
{
  "episode_id": "ep06",
  "status": "done",
  "output_name": "EP-06-ep06-agent-cli-storyboard.txt",
