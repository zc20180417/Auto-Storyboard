...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep40"
```
...
```json
{
  "episode_id": "ep40",
  "status": "done",
  "output_name": "EP-40-ep40-agent-cli-storyboard.txt",
