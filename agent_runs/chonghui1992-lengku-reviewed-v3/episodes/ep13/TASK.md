...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep13"
```
...
```json
{
  "episode_id": "ep13",
  "status": "done",
  "output_name": "EP-13-ep13-agent-cli-storyboard.txt",
