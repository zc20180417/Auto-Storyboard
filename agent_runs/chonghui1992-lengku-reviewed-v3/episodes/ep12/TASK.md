...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep12"
```
...
```json
{
  "episode_id": "ep12",
  "status": "done",
  "output_name": "EP-12-ep12-agent-cli-storyboard.txt",
