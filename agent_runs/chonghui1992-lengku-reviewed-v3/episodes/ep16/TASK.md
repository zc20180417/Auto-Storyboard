...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\chonghui1992-lengku-reviewed-v3\episodes\ep16"
```
...
```json
{
  "episode_id": "ep16",
  "status": "done",
  "output_name": "EP-16-ep16-agent-cli-storyboard.txt",
