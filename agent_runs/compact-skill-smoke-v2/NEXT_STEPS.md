...
- worker 1: `G:\Auto-Storyboard\agent_runs\compact-skill-smoke-v2\episodes\ep30\agent_prompt.md`

When any worker finishes, dispatch the next unfinished episode prompt.

## Episode Tasks

- `ep30`: dispatch `G:\Auto-Storyboard\agent_runs\compact-skill-smoke-v2\episodes\ep30\agent_prompt.md` to one worker. Worker writes only under `G:\Auto-Storyboard\agent_runs\compact-skill-smoke-v2\episodes\ep30`.

## Pending Prompt List

- `G:\Auto-Storyboard\agent_runs\compact-skill-smoke-v2\episodes\ep30\agent_prompt.md`
...
```powershell
codex exec --skip-git-repo-check --sandbox workspace-write --cd "G:\Auto-Storyboard\agent_runs\compact-skill-smoke-v2" - < "G:\Auto-Storyboard\agent_runs\compact-skill-smoke-v2\episodes\ep30\agent_prompt.md"
```

Qwen example:

```powershell
qwen < "G:\Auto-Storyboard\agent_runs\compact-skill-smoke-v2\episodes\ep30\agent_prompt.md"
```
