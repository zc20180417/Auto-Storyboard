...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\youyuanzhai6-scene\episodes\ep06"
```
...
```json
{
  "episode_id": "ep06",
  "status": "done",
  "output_name": "有缘斋-ep06-agent-cli-storyboard.txt",
