...
- `ep01`: dispatch `G:\Auto-Storyboard\agent_runs\happyhorse-nitui-test2-tuner-scene\episodes\ep01\agent_prompt.md` to one worker. Worker writes only under `G:\Auto-Storyboard\agent_runs\happyhorse-nitui-test2-tuner-scene\episodes\ep01`.
- `ep02`: dispatch `G:\Auto-Storyboard\agent_runs\happyhorse-nitui-test2-tuner-scene\episodes\ep02\agent_prompt.md` to one worker. Worker writes only under `G:\Auto-Storyboard\agent_runs\happyhorse-nitui-test2-tuner-scene\episodes\ep02`.
...
```powershell
codex exec --skip-git-repo-check --sandbox workspace-write --cd "G:\Auto-Storyboard\agent_runs\happyhorse-nitui-test2-tuner-scene" - < "G:\Auto-Storyboard\agent_runs\happyhorse-nitui-test2-tuner-scene\episodes\ep01\agent_prompt.md"
```

Qwen example:

```powershell
qwen < "G:\Auto-Storyboard\agent_runs\happyhorse-nitui-test2-tuner-scene\episodes\ep01\agent_prompt.md"
```
