...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\test_0505_scene_split\episodes\ep04"
```
...
- `output_name`: `test_0505-ep04-agent-cli-storyboard.txt`
