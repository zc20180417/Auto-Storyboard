...
```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\shuangxue-qinglan-claude\episodes\ep17" --pre-check
```

For segment-level pre-check (scene mode, validate a segment draft before review):

```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\shuangxue-qinglan-claude\episodes\ep17" --pre-check --content-file "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\shuangxue-qinglan-claude\episodes\ep17/segments/segXX/draft.txt"
```

Full validation command (run after review.txt and status.json are written):

```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\shuangxue-qinglan-claude\episodes\ep17"
```
...
- `output_name`: `《霜雪落尽见清兰》-ep17-agent-cli-storyboard.txt`
