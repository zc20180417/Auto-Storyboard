...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\manjidiwang-seedance-profile-first5\episodes\ep05"
```
...
- `output_name`: `EP-05-ep05-agent-cli-storyboard.txt`
