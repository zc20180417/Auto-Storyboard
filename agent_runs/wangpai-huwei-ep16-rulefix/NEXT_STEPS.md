...
- batch 1: `ep16` -> `H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-ep16-rulefix\episodes\ep16\agent_prompt.md`

Initial worker wave:

- worker 1: `ep16` -> `H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-ep16-rulefix\episodes\ep16\agent_prompt.md`

When any worker finishes, dispatch the next unfinished worker batch from the dynamic plan.

## Episode Tasks

- `ep16`: dispatch `H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-ep16-rulefix\episodes\ep16\agent_prompt.md` to one worker. Worker writes only under `H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-ep16-rulefix\episodes\ep16`.

## Pending Prompt List

- `H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-ep16-rulefix\episodes\ep16\agent_prompt.md`
...
```powershell
codex exec --skip-git-repo-check --sandbox workspace-write --cd "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-ep16-rulefix" - < "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-ep16-rulefix\episodes\ep16\agent_prompt.md"
```

Qwen example:

```powershell
qwen < "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-ep16-rulefix\episodes\ep16\agent_prompt.md"
```
