...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\ceshijuben\episodes\ep07"
```
...
```json
{
  "episode_id": "ep07",
  "status": "done",
  "output_name": "测试剧本-ep07-agent-cli-storyboard.txt",
