...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\ceshijuben\episodes\ep04"
```
...
```json
{
  "episode_id": "ep04",
  "status": "done",
  "output_name": "测试剧本-ep04-agent-cli-storyboard.txt",
