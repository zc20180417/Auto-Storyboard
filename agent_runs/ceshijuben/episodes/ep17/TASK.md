...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\ceshijuben\episodes\ep17"
```
...
```json
{
  "episode_id": "ep17",
  "status": "done",
  "output_name": "测试剧本-ep17-agent-cli-storyboard.txt",
