...
```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\jianpo-jiutian-ep05-07-horizontal-cg-fx\episodes\ep07" --pre-check
```

For segment-level pre-check (scene mode, validate a segment draft before review):

```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\jianpo-jiutian-ep05-07-horizontal-cg-fx\episodes\ep07" --pre-check --content-file "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\jianpo-jiutian-ep05-07-horizontal-cg-fx\episodes\ep07/segments/segXX/draft.txt"
```

Full validation command (run after review.txt and status.json are written):

```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\jianpo-jiutian-ep05-07-horizontal-cg-fx\episodes\ep07"
```
...
- `output_name`: `剑破九天-ep07-agent-cli-storyboard.txt`
