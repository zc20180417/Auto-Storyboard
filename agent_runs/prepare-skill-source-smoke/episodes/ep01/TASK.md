...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\prepare-skill-source-smoke\episodes\ep01"
```
...
```json
{
  "episode_id": "ep01",
  "status": "done",
  "output_name": "script-ep01-agent-cli-storyboard.txt",
