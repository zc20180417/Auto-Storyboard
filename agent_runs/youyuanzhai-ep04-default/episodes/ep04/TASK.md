...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\youyuanzhai-ep04-default\episodes\ep04"
```
...
```json
{
  "episode_id": "ep04",
  "status": "done",
  "output_name": "有缘斋-ep04-agent-cli-storyboard.txt",
