...
- `ep04`: open `G:\Auto-Storyboard\agent_runs\youyuanzhai-ep04-default\episodes\ep04\agent_prompt.md` and process it as an independent episode. Required outputs are under `G:\Auto-Storyboard\agent_runs\youyuanzhai-ep04-default\episodes\ep04`.
...
```powershell
codex exec --skip-git-repo-check --sandbox workspace-write --cd "G:\Auto-Storyboard\agent_runs\youyuanzhai-ep04-default" - < "G:\Auto-Storyboard\agent_runs\youyuanzhai-ep04-default\episodes\ep04\agent_prompt.md"
```

Qwen example:

```powershell
qwen < "G:\Auto-Storyboard\agent_runs\youyuanzhai-ep04-default\episodes\ep04\agent_prompt.md"
```
