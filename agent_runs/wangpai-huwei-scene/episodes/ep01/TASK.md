...
```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-scene\episodes\ep01" --pre-check
```

For segment-level pre-check (scene mode, validate a segment draft before review):

```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-scene\episodes\ep01" --pre-check --content-file "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-scene\episodes\ep01/segments/segXX/draft.txt"
```

Full validation command (run after review.txt and status.json are written):

```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-scene\episodes\ep01"
```
