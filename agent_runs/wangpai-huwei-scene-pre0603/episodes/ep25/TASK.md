...
```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-scene-pre0603\episodes\ep25" --pre-check
```

For segment-level pre-check (scene mode, validate a segment draft before review):

```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-scene-pre0603\episodes\ep25" --pre-check --content-file "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-scene-pre0603\episodes\ep25/segments/segXX/draft.txt"
```

Full validation command (run after review.txt and status.json are written):

```powershell
python "H:\BaiduNetdiskDownload\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "H:\BaiduNetdiskDownload\Auto-Storyboard\agent_runs\wangpai-huwei-scene-pre0603\episodes\ep25"
```
...
- `output_name`: `《王牌护卫》-ep25-agent-cli-storyboard.txt`
...
- Work only inside `episodes\ep25`. Treat project-level skill files and `../../context.md` as read-only.
