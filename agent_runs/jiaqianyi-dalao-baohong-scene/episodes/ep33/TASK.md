...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\jiaqianyi-dalao-baohong-scene\episodes\ep33"
```
...
```json
{
  "episode_id": "ep33",
  "status": "done",
  "output_name": "嫁给千亿大佬后我发疯爆红-ep33-agent-cli-storyboard.txt",
