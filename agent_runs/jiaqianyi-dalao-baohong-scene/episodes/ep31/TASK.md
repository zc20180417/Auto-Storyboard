...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\jiaqianyi-dalao-baohong-scene\episodes\ep31"
```
...
```json
{
  "episode_id": "ep31",
  "status": "done",
  "output_name": "嫁给千亿大佬后我发疯爆红-ep31-agent-cli-storyboard.txt",
