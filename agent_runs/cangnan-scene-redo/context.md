...
- Generation rules source: `G:\Auto-Storyboard\6688竖屏古装分镜prompt.txt`
- Review rules source: `G:\Auto-Storyboard\agent_skills\storyboard-reviewer\SKILL.md`
- Final output directory: `G:\Auto-Storyboard\outputs_agent_cangnan_scene_redo`
- Episodes in this run: `33`
