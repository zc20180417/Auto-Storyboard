...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\zhangben-zhangba\episodes\ep05"
```
...
```json
{
  "episode_id": "ep05",
  "status": "done",
  "output_name": "我靠一本账本，扳倒村霸-ep05-agent-cli-storyboard.txt",
