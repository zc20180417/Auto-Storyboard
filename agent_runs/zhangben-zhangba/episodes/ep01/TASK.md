...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\zhangben-zhangba\episodes\ep01"
```
...
```json
{
  "episode_id": "ep01",
  "status": "done",
  "output_name": "我靠一本账本，扳倒村霸-ep01-agent-cli-storyboard.txt",
