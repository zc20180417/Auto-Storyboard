...
默认资产提示词沿用真人短剧口径：真人定妆照、真实空镜、真实道具材质、电影质感、自然光影。

当 run 使用 `visual_style=3d-cg` 时，资产表必须切换为动漫 3D CG 生产口径：

- 人物基础资产写成“动漫3D角色模型设定”，强调角色比例、二次元脸型、风格化眼睛、稳定脸部特征、发型体块、体态、清晰轮廓线、表情绑定友好特征和可复用身份气质；不要写成真人演员定妆照。
- 服装资产写清建模层次、布料材质、颜色、磨损、鞋配和可复用状态。
- 场景基础资产写成“动漫3D空镜环境资产”，保持无人、无人脸、无人群，强调空间结构、PBR材质与手绘质感融合、核心陈设、风格化渲染层次和电影级布光。
- 道具基础资产写成“关键道具3D模型设定”，强调材质、形状、尺寸感、状态变化和文字限制。
- 动作特效资产只提取需要跨镜稳定复用的效果状态，例如武器冷冽刀光、断刃冷光闪爆、碎石悬浮、贴地冲击尘浪、毒箭黑绿色毒雾、金属裂纹冷光；普通一次性火星、短促空气震动、轻微衣摆风压通常不入库。
- 正向提示词可以使用“高质量动漫3D CG短剧风格、二次元角色设计、风格化面部与眼睛、清晰轮廓线、高质量卡通渲染、PBR材质与手绘质感融合、电影级渲染、细腻表情绑定、动作服务型大片特效、冷冽刀光、气流压迫、碎石悬浮、贴地冲击尘浪、金属裂纹冷光”等媒介词。
- 负面提示词不要禁止“3D渲染”“CG感”“动画感”“卡通”“动漫”或“二次元”本身；应避免“低多边形、廉价游戏建模、塑料玩具感、面部僵硬、表情死板、眼神空洞、口型错位、穿模、骨骼错位、材质粗糙、贴图拉伸、轮廓线抖动、满屏粒子、过曝光效、遮脸光效、特效盖住主体、游戏技能UI、法阵文字、魔法阵、水印、logo、字幕”。

无论哪种视觉风格，资产抽取规则不变：基础资产只入库一次，状态变化单独建模，普通桌椅门窗、短暂表情、一次性手势和背景杂物通常不入库。
