...
- 为满足 10 秒下限而硬塞强节拍、拖慢台词、增加长凝视或普通沉默。（有动机戏剧停顿的例外见下文“有动机镜头语言的识别”。）
...
- **有动机戏剧停顿**：紧接 reveal/反转/身份揭穿/关系崩塌等高冲击节拍后的 1.5-2.5 秒无台词反应镜头，且镜头描述承载明确可见反应变化（瞳孔收缩、下颌松开、眼眶泛红、呼吸一滞等）的，属合法戏剧呼吸，不判 `generation_density` 凑时长，也不计入“连续无台词铺垫超时”。仍判 hard 的情况：无可见反应变化的死凝视/空洞静止；未锚定到高冲击节拍；连用多个反应停顿；或被用来把本不足 10 秒的组凑到 10 秒以上。
