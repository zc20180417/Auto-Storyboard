...
```powershell
python "G:\Auto-Storyboard\storyboard_agent_workspace.py" validate-episode --episode-dir "G:\Auto-Storyboard\agent_runs\youyuanzhai-single\episodes\ep05"
```
...
```json
{
  "episode_id": "ep05",
  "status": "done",
  "output_name": "有缘斋-ep05-agent-cli-storyboard.txt",
